...
if(cam_lidar_calib_CONFIG_INCLUDED)
  return()
endif()
set(cam_lidar_calib_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(cam_lidar_calib_SOURCE_PREFIX /home/pw/cjy_home/c_ws/src/cam_lidar_calib)
  set(cam_lidar_calib_DEVEL_PREFIX /home/pw/cjy_home/c_ws/src/cam_lidar_calib/build/devel)
  set(cam_lidar_calib_INSTALL_PREFIX "")
  set(cam_lidar_calib_PREFIX ${cam_lidar_calib_DEVEL_PREFIX})
else()
  set(cam_lidar_calib_SOURCE_PREFIX "")
  set(cam_lidar_calib_DEVEL_PREFIX "")
  set(cam_lidar_calib_INSTALL_PREFIX /usr/local)
  set(cam_lidar_calib_PREFIX ${cam_lidar_calib_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'cam_lidar_calib' is deprecated")
...
set(cam_lidar_calib_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/pw/cjy_home/c_ws/src/cam_lidar_calib/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(cam_lidar_calib_INCLUDE_DIRS "")
  set(_include_dirs "/home/pw/cjy_home/c_ws/src/cam_lidar_calib/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${cam_lidar_calib_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cam_lidar_calib' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'cam_lidar_calib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pw/cjy_home/c_ws/src/cam_lidar_calib/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cam_lidar_calib_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND cam_lidar_calib_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND cam_lidar_calib_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT cam_lidar_calib_NUM_DUMMY_TARGETS)
      set(cam_lidar_calib_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cam_lidar_calib::wrapped-linker-option${cam_lidar_calib_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cam_lidar_calib_NUM_DUMMY_TARGETS "${cam_lidar_calib_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cam_lidar_calib::wrapped-linker-option${cam_lidar_calib_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cam_lidar_calib_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pw/cjy_home/c_ws/src/cam_lidar_calib/build/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(cam_lidar_calib_LIBRARY_DIRS ${lib_path})
      list(APPEND cam_lidar_calib_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'cam_lidar_calib'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND cam_lidar_calib_LIBRARIES ${lib})
    endif()
  endif()
...
set(cam_lidar_calib_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${cam_lidar_calib_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 cam_lidar_calib_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${cam_lidar_calib_dep}_FOUND)
      find_package(${cam_lidar_calib_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cam_lidar_calib_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(cam_lidar_calib_INCLUDE_DIRS ${${cam_lidar_calib_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(cam_lidar_calib_LIBRARIES ${cam_lidar_calib_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${cam_lidar_calib_dep}_LIBRARIES})
  _list_append_deduplicate(cam_lidar_calib_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(cam_lidar_calib_LIBRARIES ${cam_lidar_calib_LIBRARIES})

  _list_append_unique(cam_lidar_calib_LIBRARY_DIRS ${${cam_lidar_calib_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(cam_lidar_calib_EXPORTED_TARGETS ${${cam_lidar_calib_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${cam_lidar_calib_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
